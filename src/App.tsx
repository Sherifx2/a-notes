...
function App() {
  ...
  return (
    <div className='flex'>
      {/* nav */}
      <div className='text-left mb-4 w-[40em]'>
        <div className="fixed pr-4 h-screen overflow-y-scroll">
          {/* mod 1 */}
          ...
          <div className="flex">
            ...
            <ul className='ml-2'>
              <li>
                <a href="#" className='hover:underline mb-4 text-black dark:text-white cursor-pointer hover:text-slate-600 dark:hover:text-red-100 '><span className='mr-2'>#</span>x</a>
              </li>
              <li>
                <a href="#" className='hover:underline mb-4 text-black dark:text-white cursor-pointer hover:text-slate-600 dark:hover:text-red-100 '><span className='mr-2'>#</span>x</a>
              </li>
          ...
          {/* mod 25*/}
          <a href="#module-17" className='text-xl font-bold hover:underline cursor-pointer text-black hover:font-black hover:text-black dark:hover:text-white dark:text-white '>Server & Intrusion</a>
          <div className="flex">
            <div className="ml-5 w-1 bg-red-100 rounded-full"></div>
            <ul className='ml-2'>
              <li>
      ...
      <main className="text-left px-24">
        ...
        <div id="module-2" className='p-2'>
          <h1 className='mb-10'>Motherboards</h1>
